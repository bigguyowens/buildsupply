  ...
  return (
    <div style={{ background: "white", borderRadius: 8, border: "1px solid var(--color-border)", overflow: "hidden" }}>
      <div style={{ padding: "16px 24px", borderBottom: "1px solid var(--color-border)" }}>
        <h2 style={{ fontSize: 14, fontWeight: 700, margin: 0 }}>Change Password</h2>
        <p style={{ fontSize: 13, color: "var(--color-muted)", margin: "4px 0 0" }}>Use a strong password of at least 8 characters</p>
      </div>
      <form ref={formRef} action={formAction} style={{ padding: 24, display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <div>
          ...
          <input
            name="current" type="password" required placeholder="••••••••"
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
          <div>
            ...
            <input
              name="newPass" type="password" required placeholder="Min. 8 characters"
              style={{ width: "100%", padding: "9px 12px", borderRadius: 6, fontSize: 14, border: "1px solid var(--color-border)", outline: "none", boxSizing: "border-box" }}
            />
          </div>
          <div>
            ...
            <input
              name="confirm" type="password" required placeholder="••••••••"
              style={{ width: "100%", padding: "9px 12px", borderRadius: 6, fontSize: 14, border: "1px solid var(--color-border)", outline: "none", boxSizing: "border-box" }}
            />
          </div>
        </div>
        ...
        <div style={{ display: "flex", justifyContent: "flex-end" }}>
          <button
            ...
            style={{
              ...
              background: pending ? "#9ca3af" : "var(--color-foreground)",
