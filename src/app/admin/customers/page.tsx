  ...
  return (
    <div style={{ padding: 28 }}>
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ color: "#64748b", fontSize: 14, margin: "4px 0 0" }}>{customers.length} registered users</p>
      </div>
              ...
              <tr key={c.id} style={{ borderTop: "1px solid #f1f5f9" }}>
                <td style={{ padding: "12px 16px" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    ...
                    <span style={{ fontWeight: 600, color: "#0f172a" }}>{c.first_name} {c.last_name}</span>
                  </div>
                </td>
