  ...
  return (
    <div style={{ background: "#fff", borderRadius: 10, border: "1px solid #e5e5e5", overflow: "hidden" }}>
      <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
        ...
        <tbody>
          {customers.length === 0 ? (
            <tr><td colSpan={8} style={{ padding: "48px 24px", textAlign: "center", color: "#9ca3af" }}>
              No customers found
            </td></tr>
          ) : customers.map((c, i) => (
              ...
              <td style={{ padding: "12px 16px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  ...
                  <Link href={`/crm/customers/${c.id}`} style={{ fontWeight: 700, color: "#0d0d0d",
                    ...
                    {c.note_count > 0 && <span style={{ marginLeft: 6, fontSize: 10, color: "#9ca3af" }}>📝 {c.note_count}</span>}
                  </Link>
                </div>
              </td>
    ...
    <tr style={{ borderBottom: "1px solid #f5f5f5" }}>
      <td style={{ padding: "12px 16px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <Link href={`/crm/customers/${member.id}`} style={{ fontWeight: 700, color: "#0d0d0d",
            textDecoration: "none", fontSize: 13 }}>
      ...
      <td style={{ padding: "12px 16px" }}>
        {changing ? (
          <div style={{ display: "flex", gap: 4, flexWrap: "wrap" }}>
            ...
            <button onClick={() => setChanging(false)} style={{ fontSize: 11, color: "#9ca3af",
  ...
  return (
    <div style={{ background: "#fff", borderRadius: 10, border: "1px solid #e5e5e5", overflow: "hidden" }}>
      <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
        ...
        <tbody>
          {staff.length === 0 ? (
            <tr><td colSpan={6} style={{ padding: "48px 24px", textAlign: "center", color: "#9ca3af" }}>
              No staff found
            </td></tr>
